...
******************************************************************************************
 ...
 into a Coda Invoice XML file for TCG
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:user="http://mycompany.com/mynamespace" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="#default xsl msxsl user">
	...
	<xsl:template match="/Invoice">
		<xsl:variable name="HouseNumber" select="user:translateCustomersUnitCode(string(/Invoice/InvoiceHeader/ShipTo/ShipToLocationID/BuyersCode))"/>
		...
		<ABSformatEDIdocument>
			<coda-document-code>PIEDI</coda-document-code>

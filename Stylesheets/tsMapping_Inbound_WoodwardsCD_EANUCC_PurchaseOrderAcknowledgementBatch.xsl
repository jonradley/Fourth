...
<!--**************************************************************************************
 Overview
	...
	Woodwards CD specific acknowledgement batch mapper 
	(branched from tsMapping_Inbound_WoodwardsCD_EANUCC_PurchaseOrderAcknowledgementBatch.xsl)
					...
					<BatchDocument>
						...
						<PurchaseOrderAcknowledgement>
							...
							<TradeSimpleHeader>
								...
								<!-- /OrderAcknowledgement/Seller/SellerAssigned will not be mapped -->

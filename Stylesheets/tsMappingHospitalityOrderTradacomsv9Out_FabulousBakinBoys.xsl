...
==========================================================================================
 16/01/2008	| R Cambridge			|	1659 Branch for Fabulous Baking Boys from tsMappingHospitalityOrderTradacomsv9Out.xsl
=======================================================================================-->
			...
			<xsl:text>OLD=</xsl:text>
				...
				<xsl:call-template name="msCheckField">
					<xsl:with-param name="vobjNode">
						<xsl:choose>
							<xsl:when test="string(ProductID/SuppliersProductCode) != ''">

					...
					<BatchDocument>
				      ...
				      ~~~~~~~~~~~~~~~~~~~~~~~ -->
							<CreditNoteHeader>
								...
								<Buyer>
									<BuyersLocationID>
										<!-- Case 828: xsl:if test="string(/CreditNote/Buyer/BuyerGLN) !='' ">
											<GLN>
												<xsl:value-of select="/CreditNote/Buyer/BuyerGLN"/>
											</GLN>
										</xsl:if -->
										...
										<xsl:if test="string(//TradeAgreementReference/ContractReferenceNumber)">
											<SuppliersCode>
												<!-- Case 828: xsl:value-of select="/CreditNote/Buyer/SellerAssigned"/ -->
												...
												<xsl:otherwise>
													<xsl:choose>
														<xsl:when test="/CreditNote/TaxPointDateTime !=''">
															<xsl:choose>
																<xsl:when test="translate(substring(/CreditNote/TaxPointDateTime,1,10),'-','')  &lt;= translate('2008-11-30','-','') or translate(substring(/CreditNote/TaxPointDateTime,1,10),'-','')  &gt;= translate('2010-01-01','-','')">
														...
														<xsl:when test="/CreditNote/CreditNoteDate !=''">
															<xsl:choose>
																<xsl:when test="translate(substring(/CreditNote/CreditNoteDate,1,10),'-','')  &lt;= translate('2008-11-30','-','')  or translate(substring(/CreditNote/CreditNoteDate,1,10),'-','')  &gt;= translate('2010-01-01','-','') ">
																	<xsl:value-of select="format-number($defaultTaxRate, '0.00')"/>
																</xsl:when>
																<xsl:otherwise>
																	<xsl:value-of select="format-number($defaultTaxRateNew, '0.00')"/>
												...
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:choose>
															...
															<xsl:when test="/CreditNote/CreditNoteDate !=''">
																<xsl:choose>
																	<xsl:when test="translate(substring(/CreditNote/CreditNoteDate,1,10),'-','')  &lt;= translate('2008-11-30','-','') or translate(substring(/CreditNote/TaxPointDateTime,1,10),'-','')  &gt;= translate('2010-01-01','-','')">
																		<xsl:value-of select="format-number($defaultTaxRate, '0.00')"/>
																	</xsl:when>
																	<xsl:otherwise>
																		<xsl:value-of select="format-number($defaultTaxRateNew, '0.00')"/>
															...
															<xsl:otherwise>
																<xsl:choose>
																	<xsl:when test="translate($CurrentDate,'-','')  &lt;= translate('2008-11-30','-','') or translate(substring(/CreditNote/TaxPointDateTime,1,10),'-','')  &gt;= translate('2010-01-01','-','')">
																		<xsl:value-of select="format-number($defaultTaxRate, '0.00')"/>
																	</xsl:when>
																	<xsl:otherwise>
																		<xsl:value-of select="format-number($defaultTaxRateNew, '0.00')"/>

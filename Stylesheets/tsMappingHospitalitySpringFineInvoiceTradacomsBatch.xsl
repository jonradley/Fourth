...
<!-- 
SPRING FINE FOODS
29th March 05 Andy Trafford Created from tsMappingHospitlaityFirstChoiceInvoiceTradacomsBatch.xsl, to use support for SCR in CLO-CLO(3) if not found in CLO-CLOC(2)
-->

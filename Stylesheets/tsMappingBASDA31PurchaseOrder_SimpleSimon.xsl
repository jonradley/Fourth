...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:schemas-basda-org:2000:purchaseOrder:xdr:3.01"  version="1.0">
	...
	<xsl:template match="/PurchaseOrder">
		...
		<Order>
			...
			<Buyer>
				<BuyerReferences>
					<SuppliersCodeForBuyer><xsl:value-of select="PurchaseOrderHeader/ShipTo/ShipToLocationID/SuppliersCode"/></SuppliersCodeForBuyer>
					<!--TaxNumber/-->
			...
			<Delivery>
				<DeliverTo>
					<DeliverToReferences>
						<BuyersCodeForLocation>00</BuyersCodeForLocation>
						<!--TaxNumber/-->

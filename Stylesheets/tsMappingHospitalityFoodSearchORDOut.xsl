...
******************************************************************************************
 08/01/2005  	| M Dimant	| 7861: Created
******************************************************************************************
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<xsl:template match="PurchaseOrder">
		...
		<!-- We insert supplier's site code and PL account code here (and not the location name) so it can be returned in the invoice/credit. -->
		<xsl:value-of select="PurchaseOrderHeader/ShipTo/ShipToLocationID/SuppliersCode"/>
		<!-- Forward slash used as a seperator -->
		<xsl:text>/</xsl:text>

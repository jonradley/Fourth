...
<!--***************************************************************************************
 ...
 Overview 
	...
	Branched from tsMappingBASDA24PurchaseOrder.xsl
	
	Simple Simon don't want the BizTalk wrapper
...
******************************************************************************************
 20/02/2008  | R Cambridge  | Created        
******************************************************************************************
14/02/2013   | M Emanuel    | 6021 Adding a new mapper for Simple Simon Fish copied from tsMappingBASDA24PurchaseOrder_SimpleSimon.xsl
***************************************************************************************-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:schemas-basda-org:2000:purchaseOrder:xdr:3.01" xsi:schemaLocation="urn:schemas-basda-org:2000:purchaseOrder:xdr:3.01 http://localhost/xml/basda/xsd/order-v3.xsd" version="1.0">

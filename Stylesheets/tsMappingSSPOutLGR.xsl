	...
	<xsl:template match="/">
		...
		<xsl:element name="Nexus">	
			<xsl:element name="Header">
				...
				<xsl:element name="Reference">
					...
					<xsl:element name="RefCode">
						<xsl:value-of select="/LynxGoodsReceivedNote/LynxGoodsReceivedNoteHeader/LynxSupplierReferences/UNOReference"/>
					</xsl:element>
				</xsl:element>
				...
				<xsl:element name="Reference">
					...
					<xsl:element name="RefCode">
						<xsl:value-of select="/LynxGoodsReceivedNote/LynxGoodsReceivedNoteHeader/LynxDeliveryNoteReferences/DeliveryNoteReference"/>
					</xsl:element>
				</xsl:element>
				...
				<xsl:element name="Reference">
					...
					<xsl:element name="RefCode">
						<xsl:value-of select="/LynxGoodsReceivedNote/LynxGoodsReceivedNoteHeader/LynxPurchaseOrderReferences/PurchaseOrderReference"/>
					</xsl:element>
				</xsl:element>			
				...
				<xsl:element name="DateInfo">
					...
					<xsl:element name="Date">
						<xsl:value-of select="/LynxGoodsReceivedNote/LynxGoodsReceivedNoteHeader/GoodsReceivedNoteReferences/GoodsReceivedNoteDate"/>
					</xsl:element>
				</xsl:element>		
				...
				<xsl:element name="Supplier">
					<xsl:element name="PartyCode">
						...
						<xsl:element name="IdCode">
							<xsl:value-of select="/LynxGoodsReceivedNote/TradeSimpleHeader/SendersCodeForRecipient"/>
						</xsl:element>
					</xsl:element>
				</xsl:element>		
				...
				<xsl:element name="Narrative">
					<xsl:element name="Text">
						<xsl:value-of select="/LynxGoodsReceivedNote/LynxGoodsReceivedNoteHeader/Narrative"/>
					</xsl:element>
				</xsl:element>
			</xsl:element>
			...
			<xsl:element name="Body">
				...
				<xsl:for-each select="/LynxGoodsReceivedNote/LynxGoodsReceivedNoteDetail/LynxGoodsReceivedNoteLine">
					...
					<xsl:element name="Line">
						...
						<xsl:element name="Product">
							...
							<xsl:element name="ProdNum">
								<xsl:value-of select="LynxProductID/SuppliersProductCode"/>
							</xsl:element>

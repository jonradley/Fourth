...
********************************************************************************************************************************
12/02/2018	| W Nassor		| FB 12252: Created Module
********************************************************************************************************************************-->				
...
<BatchRoot>
	...
	<!--To Manipulate the date string into tradesimple format-->
	<xsl:template match="CreditNoteDate | InvoiceDate | PurchaseOrderDate | DeliveryNoteDate | TaxPointDate">

...
<!--
'*************************************************************************************
Maps iXML invoices into OFSCI format for iTN (Compass).
**************************************************************************************
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:script="http://mycompany.com/mynamespace" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns="http://www.eanucc.org/2002/Pay/FoodService/FoodService/UK/EanUcc/Pay" xmlns:cc="http://www.ean-ucc.org/2002/gsmp/schemas/CoreComponents" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="fo script msxsl">
	...
	<xsl:template match="/">
		...
		<Invoice>
			<xsl:attribute name="xsi:schemaLocation"><xsl:text>http://www.eanucc.org/2002/Pay/FoodService/FoodService/UK/EanUcc/Pay X:\HOME\COMMON\projects\TSFOOD~1\ebXML\Invoice\0.8\Invoicev0.8.xsd</xsl:text></xsl:attribute>
			<InvoiceDocumentDetails>
				<InvoiceDocumentDate format="YYYY-MM-DDThh:mm:ss:TZD">
					<xsl:value-of select="/Invoice/InvoiceHeader/InvoiceReferences/InvoiceDate"/>T00:00:00</InvoiceDocumentDate>
						...
						<TradeAgreementReference>
							<xsl:if test="/Invoice/InvoiceDetail/InvoiceLine[1]/PurchaseOrderReferences/TradeAgreement/ContractDate">
								<ContractReferenceDate format="YYYY-MM-DDThh:mm:ss:TZD">
									<xsl:value-of select="/Invoice/InvoiceDetail/InvoiceLine[1]/PurchaseOrderReferences/TradeAgreement/ContractDate"/>T00:00:00</ContractReferenceDate>
							</xsl:if>
							<ContractReferenceNumber scheme="OTHER">
								<xsl:value-of select="/Invoice/InvoiceDetail/InvoiceLine/PurchaseOrderReferences[TradeAgreement/ContractReference != ''][1]/TradeAgreement/ContractReference"/>
				...
				<OrderReference>
					<xsl:if test="/Invoice/InvoiceDetail/InvoiceLine[1]/PurchaseOrderReferences/PurchaseOrderDate">
						<PurchaseOrderDate format="YYYY-MM-DDThh:mm:ss:TZD">
							<xsl:value-of select="/Invoice/InvoiceDetail/InvoiceLine[1]/PurchaseOrderReferences/PurchaseOrderDate"/>T00:00:00</PurchaseOrderDate>
					</xsl:if>
				...
				<xsl:choose>
					<xsl:when test="/Invoice/InvoiceDetail/InvoiceLine[1]/PurchaseOrderConfirmationReferences/PurchaseOrderConfirmationDate != ''">
						<PurchaseOrderConfirmationDate format="YYYY-MM-DDThh:mm:ss:TZD">
							<xsl:value-of select="/Invoice/InvoiceDetail/InvoiceLine[1]/PurchaseOrderConfirmationReferences/PurchaseOrderConfirmationDate"/>T00:00:00</PurchaseOrderConfirmationDate>
					</xsl:when>
					<xsl:otherwise>
						<PurchaseOrderConfirmationDate format="YYYY-MM-DDThh:mm:ss:TZD">
							<xsl:value-of select="/Invoice/InvoiceDetail/InvoiceLine[1]/PurchaseOrderReferences/PurchaseOrderDate"/>T00:00:00</PurchaseOrderConfirmationDate>
					</xsl:otherwise>
				</xsl:choose>
				<xsl:choose>
				...
				<DespatchReference>
					<xsl:if test="/Invoice/InvoiceDetail/InvoiceLine[1]/DeliveryNoteReferences/DeliveryNoteDate">
						<DespatchDocumentDate format="YYYY-MM-DDThh:mm:ss:TZD">
							<xsl:value-of select="/Invoice/InvoiceDetail/InvoiceLine[1]/DeliveryNoteReferences/DeliveryNoteDate"/>T00:00:00</DespatchDocumentDate>
					</xsl:if>
				...
				<xsl:choose>
					<xsl:when test="/Invoice/InvoiceDetail/InvoiceLine[1]/GoodsReceivedNoteReferences/GoodsReceivedNoteDate">
						<ReceiptAdviceDocumentDate format="YYYY-MM-DDThh:mm:ss:TZD">
							<xsl:value-of select="/Invoice/InvoiceDetail/InvoiceLine[1]/GoodsReceivedNoteReferences/GoodsReceivedNoteDate"/>T00:00:00</ReceiptAdviceDocumentDate>
					</xsl:when>
					<xsl:otherwise>
						<ReceiptAdviceDocumentDate format="YYYY-MM-DDThh:mm:ss:TZD">
							<xsl:value-of select="/Invoice/InvoiceDetail/InvoiceLine[1]/DeliveryNoteReferences/DeliveryNoteDate"/>T00:00:00</ReceiptAdviceDocumentDate>
					</xsl:otherwise>
				</xsl:choose>
				<xsl:choose>
			...
			<Seller>
				...
				<VATRegisterationNumber scheme="OTHER">GB<xsl:value-of select="/Invoice/InvoiceHeader/InvoiceReferences/VATRegNo"/>
			...
			<ShipTo>
				...
				<xsl:if test="/Invoice/InvoiceHeader/ShipTo/ShipToLocationID/BuyersCode">
					<BuyerAssigned scheme="OTHER">
						<xsl:choose>
							<xsl:when test="substring-after(/Invoice/InvoiceHeader/ShipTo/ShipToLocationID/BuyersCode, '|')">
								<xsl:value-of select="substring-after(/Invoice/InvoiceHeader/ShipTo/ShipToLocationID/BuyersCode, '|')"/>
							</xsl:when>
							<xsl:otherwise>
				...
				<xsl:if test="/Invoice/InvoiceHeader/ShipTo/ShipToLocationID/SuppliersCode">
					<SellerAssigned scheme="OTHER">
						<xsl:choose>
							<xsl:when test="substring-before(/Invoice/InvoiceHeader/ShipTo/ShipToLocationID/SuppliersCode, '|')">
								<xsl:value-of select="substring-before(/Invoice/InvoiceHeader/ShipTo/ShipToLocationID/SuppliersCode, '|')"/>
							</xsl:when>
							<xsl:otherwise>
			...
			<TaxPointDateTime format="YYYY-MM-DDThh:mm:ss:TZD">
				<xsl:value-of select="/Invoice/InvoiceHeader/InvoiceReferences/TaxPointDate"/>T00:00:00</TaxPointDateTime>

...
******************************************************************************************
 ...
 Maps internal invoices, credits and debits to make a copy of themselves for Aramark to store in an archive.
Done like this (rather than just routing a copy straight through) so that any new fields added to any of these documents
will NOT automatically be added to this document, as specified in the specification (ARA022)

...
Name			| Date				| Change
**********************************************************************
R Cambridge	| 17/22/2008		| 2315 Branched from tsMappingHospitalityInBevInvoiceTradacomsBatch.xsl
**********************************************************************
				|						|
**********************************************************************
				|						|
...
<BatchRoot>
	...
	<!-- Process copies (both parties have agreed these electronic documents are copies) -->

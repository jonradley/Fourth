...
==========================================================================================
 10/11/2017	|Warith Nassor 	| FB12209: X12 Purchase Order Confirmation for US Foods
==========================================================================================
-->
		...
		<xsl:element name="PurchaseOrderConfirmationDetail">
			<xsl:for-each select="PurchaseOrderConfirmationLine">
				<xsl:element name="PurchaseOrderConfirmationLine">
					...
					<!--Populate Narrative for Line Statuses -->					
						<xsl:if test=" @LineStatus = 'IP' or @LineStatus = 'IR' or @LineStatus = 'ID' or @LineStatus = 'IQ' or @LineStatus = 'IS' or @LineStatus = 'R2' or @LineStatus = 'R3' ">
							<xsl:element name="Narrative">
								<xsl:choose>
									<xsl:when test="@LineStatus = 'IP'">Item Accepted - Price Changed</xsl:when>

...
******************************************************************************************************************************************************************************************************************
R Cambridge	| 2009-07-06	  	| 2980 Send SBR / PL account code as buyer's code for seller. Add some sorry logic to populate //sh:Receiver/sh:Identifier											    
******************************************************************************************************************************************************************************************************************
 ...
 =======================================================================================-->	
	<xsl:template name="determineBuyersCode">
		...
		<xsl:choose>
			...
			<xsl:when test="$vendorGLN = '5013546062482' and $senderGLN = '5060166760007' and $buyersCode = 'S20293538804/G'">S20293538804/G</xsl:when>
			<xsl:when test="$vendorGLN = '5036036000009' and $senderGLN = '5060166760007' and $buyersCode = 'S20293538804/F'">S20293538804/F</xsl:when>		

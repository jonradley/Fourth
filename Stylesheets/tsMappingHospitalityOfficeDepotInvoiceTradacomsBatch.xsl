...
Name			| Date			| Change
**********************************************************************
R Cambridge	| 06/11/2008	| 2552 created from tsMappingHospitalityInvoiceTradacomsBatch_Catchweights.xsl
									| 		  remove leading zeros from location code
**********************************************************************
				|             	|	
**********************************************************************
				|             	|
...
<BatchRoot>
	...
	<!-- 2552 Remove leading zeros from location code -->

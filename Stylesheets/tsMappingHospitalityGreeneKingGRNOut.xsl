...
***********************************************************************************************************************************************************************************
22/03/2016	| M Dimant   | FB10881: Changed to map Aurora code from members own code. Map GRN reference instead of PO reference if PO ref doesn't exist.
**********************************************************************************************************************************************************************************
-->
  ...
  <despatchAdvice>
    ...
    <seller>
      ...
      <xsl:choose>
			...
			<xsl:otherwise>				
				<xsl:text>No Aurora code has been set for this supplier</xsl:text>
			</xsl:otherwise>						
		</xsl:choose>
      </additionalPartyIdentification>
    </seller>

...
Name			| Date				| Change
**********************************************************************
K Oshaughnessy| 2011-04-26		| 4349 Created Modue
**********************************************************************
				|						|				
*******************************************************************-->
			...
			<PurchaseOrderConfirmation>
				...
				<PurchaseOrderConfirmationHeader>
					...
					<PurchaseOrderConfirmationReferences>
						...
						<PurchaseOrderConfirmationDate><xsl:value-of select="substring-before(/sh:StandardBusinessDocument/eanucc:message/order:orderResponse/@creationDateTime,'T')"/></PurchaseOrderConfirmationDate>
					</PurchaseOrderConfirmationReferences>

...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/Invoice[InvoiceHeader/HeaderExtraData/Authorisation/IsAuthorised = '1'] | /CreditNote[CreditNoteHeader/HeaderExtraData/Authorisation/IsAuthorised = '1']">

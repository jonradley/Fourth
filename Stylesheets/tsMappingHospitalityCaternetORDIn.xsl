...
<BatchRoot>
	<PurchaseOrder >
		...
		<PurchaseOrderHeader>
			...
			<HeaderExtraData>
				<RouteNumber><xsl:value-of select="eanucc:documentCommand/documentCommandOperand/order:order/orderLogisticalInformation/shipToLogistics/shipTo/additionalPartyIdentification/additionalPartyIdentificationValue"/></RouteNumber>
			</HeaderExtraData>

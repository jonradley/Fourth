...
'******************************************************************************************
' 26/06/2009| AB | Modified for quantity/price conversion for WHL
'******************************************************************************************
-->
					...
					<xsl:for-each select="PurchaseOrderConfirmationDetail/PurchaseOrderConfirmationLine">
						...
						<PurchaseOrderConfirmationLine>
							...
							<xsl:if test="OrderedQuantity != ''">
								<OrderedQuantity>
									<xsl:value-of select="format-number((OrderedQuantity div PackSize), '0')"/>
								</OrderedQuantity>
							</xsl:if>
							
							<ConfirmedQuantity>
								<xsl:value-of select="format-number((ConfirmedQuantity div PackSize), '0')"/>
							</ConfirmedQuantity>

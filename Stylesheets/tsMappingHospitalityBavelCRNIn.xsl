						...
						<CreditNote>
							...
							<CreditNoteHeader>
								...
								<CreditNoteReferences>
									<CreditNoteReference><xsl:value-of select="GeneralData/@Ref"/></CreditNoteReference>
									<CreditNoteDate><xsl:value-of select="substring-before(concat(GeneralData/@Date,'T'), 'T')"/></CreditNoteDate>

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:jscript="http://abs-Ltd.com">
	...
	<!-- these batch tags are for the batch router and need to be left in -->
	<Batch>
		<BatchDocuments>
			<BatchDocument>
				<!-- cycles and creates an invoice xml document for each CSV invoice in the file. -->
				<xsl:for-each select="enter record name and path for each invoice document">
					<Invoice>
						<TradeSimpleHeader>
							<!--SendersCodeForRecipient-->
							<SendersCodeForRecipient>
								<xsl:value-of select="enter xpath"/>
							</SendersCodeForRecipient>
							<!-- not a mandatory element -->
							<xsl:if test="string(enter xpath) != '' ">
						...
						<InvoiceDetail>
							<InvoiceLine>
								...
								<LineExtraData>
									...
									<StandardPriceUnitCode>
										<xsl:value-of select="enter xpath"/>
									</StandardPriceUnitCode>
									<StandardDeliveryUnitCost>
										<xsl:value-of select="enter xpath"/>
									</StandardDeliveryUnitCost>
									<ProductDescription2>
										<xsl:value-of select="enter xpath"/>
									</ProductDescription2>
									<CustomersConceptProductCode>
										<xsl:value-of select="enter xpath"/>
									</CustomersConceptProductCode>
									<AccountCode>
										<xsl:value-of select="enter xpath"/>

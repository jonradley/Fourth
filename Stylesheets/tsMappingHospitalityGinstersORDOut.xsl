...
==========================================================================================
 1/08/2013		| M Dimant				|	6809: Created module based on standard Tradacoms order mapper.
==========================================================================================
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<xsl:template match="/BatchRoot">
		...
		<xsl:variable name="FGN">
			<!--Restrict FGN to 4 digit -->
			<xsl:variable name="FourDigitFGN" select="format-number(PurchaseOrder/PurchaseOrderHeader/FileGenerationNumber,'0000')"/>

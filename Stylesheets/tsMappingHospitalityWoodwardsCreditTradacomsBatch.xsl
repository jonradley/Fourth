...
**********************************************************************
R cambridge	| 04/01/2007	| 664 Adapted for Woodwoods from 
									  tsMappingHospitalityCreditTradacomsBatch.xsl
**********************************************************************
				|					|
**********************************************************************
-->
...
<BatchRoot>
	...
	<!-- CLD-QTYC(1) (CreditNoteLine/CreditedQuantity) needs to be multiplied by -1 if (CreditNoteLine/ProductID/BuyersProductCode) is NOT blank -->
	<!-- 664 remove OrderedQuantity, catchwieght products quantities are held there. -->
	<xsl:template match="CreditNoteLine/OrderedQuantity"/>	
	
	<xsl:template match="CreditNoteLine/OrderedQuantity[not(following-sibling::CreditedQuantity)] | CreditNoteLine/CreditedQuantity[not(preceding-sibling::OrderedQuantity)]">					

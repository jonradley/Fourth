...
**********************************************************************
R Cambridge	| 20/02/2007	| 816 remove sender's branch reference
**********************************************************************
           	|            	| 
**********************************************************************
-->
...
<BatchRoot>
	...
	<!-- /Batch/BatchDocuments/BatchDocument/CreditNote/TradeSimpleHeader/SendersBranchReference should not be copied over -->
	<xsl:template match="CreditNote/TradeSimpleHeader/SendersBranchReference"/>

...
==========================================================================================================
16/01/2014	| M Dimant			| 7623: Made changes to remove escape characters in strings, but not colons as Ocado use them in their codes
==========================================================================================================-->
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<xsl:template match="/Invoice">
		...
		<xsl:text>STX=</xsl:text>
			...
			<xsl:text>:</xsl:text>
			<xsl:choose>
				<xsl:when test="InvoiceHeader/Supplier/SuppliersName = 'Fairfax Meadow'">

				...
				<xsl:choose>
					<xsl:when test="substring($VATCode,1,1) = 'L'">
						...
						<xsl:when test="../../../InvoiceHeader/InvoiceReferences/TaxPointDate!='' or ../../../CreditNoteHeader/InvoiceReferences/TaxPointDate!='' ">
							<xsl:choose>
								<xsl:when test="translate(substring(../../../InvoiceHeader/InvoiceReferences/TaxPointDate,1,10),'-','') &gt;= translate('2011-01-04','-','') or translate(substring(../../../CreditNoteHeader/InvoiceReferences/TaxPointDate,1,10),'-','') &gt;= translate('2011-01-04','-','')">S20.0</xsl:when>
						...
						<xsl:when test="../../../InvoiceHeader/InvoiceReferences/InvoiceDate!='' or ../../../CreditNoteHeader/InvoiceReferences/InvoiceDate!=''">
							<xsl:choose>
								<xsl:when test="translate(substring(../../../InvoiceHeader/InvoiceReferences/InvoiceDate,1,10),'-','') &gt;= translate('2011-01-04','-','') or translate(substring(../../../CreditNoteHeader/InvoiceReferences/InvoiceDate,1,10),'-','') &gt;= translate('2011-01-04','-','')">S20.0</xsl:when>
						...
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="translate($CurrentDate,'-','')  &gt;= translate('2011-01-04','-','')">S20.0</xsl:when>

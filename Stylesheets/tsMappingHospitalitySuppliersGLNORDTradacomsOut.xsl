...
Maps internal orders into outbound Tradacoms standard, but inserts the supplier's GLN in 
the STX segment.
...
==========================================================================================
 15/01/2013	| M Dimant	| 5866: Created, based on standard Tradacoms mapper.
==========================================================================================
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<xsl:template match="/PurchaseOrder">
		...
		<xsl:text>STX=</xsl:text>
			...
			<!--Suplier's mailbox (GLN) reference-->

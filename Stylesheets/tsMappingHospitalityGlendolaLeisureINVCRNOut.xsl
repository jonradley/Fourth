...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/BatchRoot">
		...
		<!-- Column Headers -->
		<xsl:text>Account Code</xsl:text>
		<xsl:text>,</xsl:text>
		<xsl:text>Base Amount</xsl:text>
		<xsl:text>,</xsl:text>
		<xsl:text>Transaction Date</xsl:text>
		<xsl:text>,</xsl:text>
		<xsl:text>Transaction Reference</xsl:text>
		<xsl:text>,</xsl:text>
		<xsl:text>Description</xsl:text>
		<xsl:text>,</xsl:text>
		<xsl:text>T3  Operation / Dept Analysis Code</xsl:text>
		<xsl:text>,</xsl:text>
		<xsl:text>T5  VAT Code Analysis Code</xsl:text>
		<xsl:text>&#13;&#10;</xsl:text>

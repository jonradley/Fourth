...
Name			| Date				| Change
**********************************************************************
M Dimant		| 20/08/2013		|  6809: Created stylesheet
**********************************************************************
-->
	...
	<xsl:template match="InvoiceLine">
		<InvoiceLine>
			...
			<DeliveryNoteReferences>
				<xsl:variable name="sDNRefReference" select="translate(../InvoiceLine[1]/DeliveryNoteReferences/DeliveryNoteReference,' ','')"/>
				<xsl:variable name="sDNRefDate" select="translate(../InvoiceLine[1]/DeliveryNoteReferences/DeliveryNoteDate,' ','')"/>
				<DeliveryNoteReference>
					<xsl:value-of select="$sDNRefReference"/>
				</DeliveryNoteReference>
				<DeliveryNoteDate>
					<xsl:value-of select="concat('20',substring($sDNRefDate,1,2),'-',substring($sDNRefDate,3,2),'-',substring($sDNRefDate,5,2))"/>
				</DeliveryNoteDate>
			</DeliveryNoteReferences>			

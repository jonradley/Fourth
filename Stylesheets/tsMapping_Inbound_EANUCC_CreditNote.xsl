				...
				<CreditNoteDetail>
					...
					<xsl:for-each select="/CreditNote/CreditItem">
						...
						<CreditNoteLine>
							...
							<xsl:if test="/CreditNote/OrderReference or /CreditNote/TradeAgreementReference">
								<PurchaseOrderReferences>
									...
									<xsl:if test="/CreditNote/TradeAgreementReference">
										<TradeAgreement>
											<ContractReference>
												<xsl:value-of select="/CreditNote/TradeAgreementReference/ContractReferenceNumber"/>
											</ContractReference>
								...
								<xsl:attribute name="UnitOfMeasure">
									<xsl:choose>
										<xsl:when test="CreditQuantity">
											<xsl:value-of select="CreditQuantity/@unitCode"/>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="$defaultUnitOfMeasure"/>
										</xsl:otherwise>
									</xsl:choose>
								</xsl:attribute>
							...
							<xsl:if test="@ChangeReasonCoded = '1' or @ChangeReasonCoded = '2' or @ChangeReasonCoded = '3' or 	@ChangeReasonCoded = '4' or @ChangeReasonCoded = '5' or 
								...
								<Narrative>
									<xsl:attribute name="Code">
										<xsl:value-of select="@ChangeReasonCoded"/>
									</xsl:attribute>
								</Narrative>
							</xsl:if>
						...
						<xsl:for-each select="/CreditNote/CreditTotals/VATRateTotals">
							...
							<VATSubTotal>
								...
								<xsl:attribute name="VATRate">
									<xsl:value-of select="format-number($currentVATRate,'0.00')"/>
								</xsl:attribute>

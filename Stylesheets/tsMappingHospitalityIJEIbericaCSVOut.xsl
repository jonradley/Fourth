...
<!--================================================================================================================================================================================
 Overview: Iberica CSV Invoice Journal Export 
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:js="http://www.abs-ltd.com/dummynamespaces/javascript">
	...
	<xsl:variable name="FieldSeperator" select="','"/>
		...
		<!-- Column Header line -->
		<xsl:text>RecordType,BuyersUnitCode,BuyersSiteCode,BuyerName,VATAccountCode,TransactionType,InvoiceReference,DeliveryReference,FnBInternalRef,TransactionDescription,BuyersCodeForSupplier,SupplierName,DeliveryDate,InvoiceDate,CustomFinancialYear,CustomFinancialPeriod,ExportRunDate,VATCode,LineVATPercentage,LineNet,LineVAT,LineGross,CostCentreName,CreatedBy,SupplierNominalCode,CategoryName,CategoryNominal,CurrencyCode,UnitSiteName,UnitSiteNominal</xsl:text>
		<xsl:value-of select="$RecordSeperator"/>

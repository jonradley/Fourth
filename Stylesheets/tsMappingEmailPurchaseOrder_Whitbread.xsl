...
******************************************************************************************
 01/07/2008 | R Cambridge| 2306 copied from tsMappingEmailPurchaseOrder.xsl
****************************************************************************************** 
            |            |
***************************************************************************************-->
						...
						<td>
							...
							<table class="DocumentInner" cellpadding="1" cellspacing="1">
								...
								<tr>
									...
									<td align="right"><xsl:value-of select="sum(/PurchaseOrder/PurchaseOrderDetail/PurchaseOrderLine/OrderedQuantity)"/></td>
								</tr>
